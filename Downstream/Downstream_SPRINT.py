...
print ('\n\n############################################')
try:
    support = int(input('Support (Enter 0 to exit):'))
except ValueError:
    print("Not a number, setting to default 2")
    support = 2
...
file = "SPRINT_identified_regular.res"
...
while support != 0:
    ...
    # Print output
    print ('\nStarting analysis on SPRINT output taking 6 samples (x3 WT_mock) & (x3 ADAR1KO_mock)\n')
    print ('\nStep 1: Load data + Filtering (P-Support >= {})\n'.format(support))
    ...
    try:
        ...
        print("Not a number. Set to default 2")
        support = 2
    print ('############################################\n\n')
